...
<body>
    <div style="line-height:1.5; font-family:'Golos Text', sans-serif; font-family:'Golos Text', sans-serif; font-size:1rem; text-align:center">
        <main style="padding-block:2rem; padding-inline:2rem">
            <h1 style="color:#6F88FC; font-size:2rem; font-weight:bold">PROJECT VALIDATION</h1>
            <p style="color:#191A44">Dear StartEase User, the project <b>{{ $project->trademark_name }}</b> was viewed by the scientific committee of the establishment
                {{ $project->domicile_establishment->name }}. It was <b>{{ $project->status }}.</b> Here is a link to the
